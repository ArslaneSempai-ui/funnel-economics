 ...
 */
import { generate, reached, CHANNELS, SCENARIO } from "./population.js";
import { wilson, ENOUGH } from "./interval.js";
...
export function measureBy(users, channel) {
    return measure(users.filter((u) => u.channel === channel));
}
export function measureMonth(users, month) {
...
export function endToEnd(users) {
...
if (isMain(import.meta)) {
    ...
    for (let i = 0; i < PAIRS.length; i++) {
        console.log(PAIRS[i].step.padEnd(12) +
